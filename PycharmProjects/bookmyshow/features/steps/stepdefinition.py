...
#
#
# @then('user is able to book the activity')
# def book(context):
...
#
#
# @then('user is able to click on proceed')
# def proceed(context):
#     context.driver.find_element("xpath", "//button[.='Proceed']").click()
#     time.sleep(3)
#
# @then(u'user is able to enter the "{full_name}"')
...
#
#
# @then(u'user is able to enter the "{email_address}"')
